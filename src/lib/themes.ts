...
export const themes: Record<ThemeId, Theme> = {
  'deep-vault': {
    ...
    name: 'Deep Vault',
    mode: 'dark',
    background: 'radial-gradient(circle at 12% 0%, rgba(20,35,45,0.24), transparent 38%), radial-gradient(circle at 78% 8%, rgba(184,135,43,0.10), transparent 30%), linear-gradient(180deg, #03070A 0%, #05080B 100%)',
    bgCard: 'rgba(5, 12, 16, 0.92)',
    bgElevated: 'rgba(8, 16, 22, 0.94)',
  ...
  'midnight-gradient': {
    ...
    mode: 'dark',
    background: 'radial-gradient(circle at 12% 0%, rgba(20,35,45,0.28), transparent 38%), linear-gradient(180deg, #03070A 0%, #071018 58%, #05080B 100%)',
    bgCard: 'rgba(5, 12, 16, 0.92)',
    bgElevated: 'rgba(8, 16, 22, 0.94)',
    bgBorder: 'rgba(184, 135, 43, 0.22)',
    textPrimary: '#E8D7B8',
  ...
  'warm-gold-haze': {
    ...
    name: 'Warm Gold Haze',
    mode: 'dark',
    background: 'radial-gradient(circle at 82% 10%, rgba(184,135,43,0.16), transparent 32%), radial-gradient(circle at 10% 0%, rgba(20,35,45,0.22), transparent 38%), linear-gradient(180deg, #03070A 0%, #05080B 100%)',
    bgCard: 'rgba(5, 12, 16, 0.92)',
    bgElevated: 'rgba(8, 16, 22, 0.95)',
