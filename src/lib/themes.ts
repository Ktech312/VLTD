...
export const themes: Record<ThemeId, Theme> = {
  ...
  'warm-gold-haze': {
    ...
    name: 'Warm Gold Haze',
    mode: 'dark',
    background: 'radial-gradient(circle at 10% 0%, rgba(26,40,62,0.18), transparent 42%), linear-gradient(180deg, #000205 0%, #00050A 54%, #01070D 100%)',
    bgCard: 'rgba(3, 8, 14, 0.95)',
    bgElevated: 'rgba(6, 12, 20, 0.96)',
    ...
    goldGlow: '0 0 16px rgba(245,181,72,0.20), 0 0 30px rgba(184,135,43,0.10), inset 0 1px 0 rgba(255,241,168,0.28)',
