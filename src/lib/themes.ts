...
export const themes: Record<ThemeId, Theme> = {
  'deep-vault': {
    ...
    name: 'Deep Vault',
    mode: 'dark',
    background: 'radial-gradient(circle at 12% 0%, rgba(15,48,50,0.32), transparent 38%), radial-gradient(circle at 78% 8%, rgba(184,135,43,0.10), transparent 30%), linear-gradient(180deg, #02090B 0%, #030709 100%)',
    bgCard: 'rgba(7, 17, 19, 0.88)',
    bgElevated: 'rgba(10, 21, 23, 0.94)',
  ...
  'midnight-gradient': {
    ...
    mode: 'dark',
    background: 'radial-gradient(circle at 12% 0%, rgba(15,48,50,0.34), transparent 38%), linear-gradient(180deg, #02090B 0%, #031014 58%, #030709 100%)',
    bgCard: 'rgba(7, 17, 19, 0.88)',
    bgElevated: 'rgba(10, 21, 23, 0.94)',
    bgBorder: 'rgba(184, 135, 43, 0.22)',
    textPrimary: '#E8D7B8',
  ...
  'warm-gold-haze': {
    ...
    name: 'Warm Gold Haze',
    mode: 'dark',
    background: 'radial-gradient(circle at 82% 10%, rgba(184,135,43,0.16), transparent 32%), radial-gradient(circle at 10% 0%, rgba(15,48,50,0.30), transparent 38%), linear-gradient(180deg, #02090B 0%, #030709 100%)',
    bgCard: 'rgba(7, 17, 19, 0.90)',
    bgElevated: 'rgba(12, 22, 20, 0.95)',
