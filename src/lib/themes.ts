...
export const themes: Record<ThemeId, Theme> = {
  ...
  'midnight-gradient': {
    ...
    mode: 'dark',
    background: 'radial-gradient(circle at 14% 0%, rgba(28,44,68,0.30), transparent 42%), linear-gradient(180deg, #010409 0%, #050B18 58%, #030712 100%)',
    bgCard: 'rgba(4, 9, 15, 0.94)',
    bgElevated: 'rgba(7, 13, 22, 0.96)',
    bgBorder: 'rgba(184, 135, 43, 0.22)',
    textPrimary: '#E8D7B8',
  ...
  'warm-gold-haze': {
    ...
    name: 'Warm Gold Haze',
    mode: 'dark',
    background: 'radial-gradient(circle at 82% 10%, rgba(184,135,43,0.14), transparent 32%), radial-gradient(circle at 10% 0%, rgba(28,44,68,0.24), transparent 42%), linear-gradient(180deg, #010409 0%, #030712 100%)',
    bgCard: 'rgba(4, 9, 15, 0.94)',
    bgElevated: 'rgba(7, 13, 22, 0.96)',
