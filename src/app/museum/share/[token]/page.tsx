...
export default function SharedGalleryPage() {
  ...
  const model: GuestGalleryViewModel | null = useMemo(() => {
    if (!gallery || gateMode !== "entered") return null;
  ...
  if (!gallery) {
    return (
      <GalleryBackgroundShell>
        <div className="mx-auto flex min-h-screen max-w-3xl items-center justify-center px-4">
          <div className="rounded-[28px] bg-[color:var(--surface)] p-8 text-center ring-1 ring-[color:var(--border)] shadow-[var(--shadow-soft)]">
            <div className="text-[11px] tracking-[0.22em] text-[color:var(--muted2)]">
              SHARED GALLERY
            </div>
            <h1 className="mt-3 text-2xl font-semibold">Gallery unavailable</h1>
