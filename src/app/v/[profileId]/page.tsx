      ...
      <div className="mx-auto max-w-5xl px-4 pb-16">
        ...
        <div className="py-8">
          <div className="rounded-[24px] border p-5 sm:p-6" style={{ background: "rgba(15,25,45,0.85)", borderColor: "rgba(245,181,72,0.16)" }}>
            ...
            {/* Stats */}
            {items.length > 0 && (
              <div className="mt-5 flex flex-wrap divide-x rounded-xl overflow-hidden border" style={{ borderColor: "rgba(245,181,72,0.12)", background: "rgba(10,18,35,0.6)", divideColor: "rgba(245,181,72,0.08)" }}>
