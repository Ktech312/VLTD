  ...
  return new ImageResponse(
    (
      <div style={{ width: "1200px", height: "630px", display: "flex", flexDirection: "row", background: "#0A0A12", fontFamily: "'Segoe UI', system-ui, sans-serif", overflow: "hidden" }}>
        ...
        {/* Gold left bar */}
        <div style={{ width: "4px", height: "630px", background: "#C8CDD2", flexShrink: 0 }} />
        ...
        <div style={{ width: "620px", flexShrink: 0, display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "52px 56px 52px 52px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <span style={{ fontSize: "20px", fontWeight: 800, letterSpacing: "0.28em", color: "#C8CDD2" }}>VLTD</span>
            <div style={{ width: "1px", height: "16px", background: "rgba(203,208,213,0.3)", display: "flex" }} />
            <span style={{ fontSize: "14px", color: "rgba(203,208,213,0.5)", letterSpacing: "0.18em" }}>CURATOR PROFILE</span>
          </div>

          {/* Name + handle */}
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            <div style={{ fontSize: nameFontSize, fontWeight: 800, color: "#ECEDEF", lineHeight: 1.05, letterSpacing: "-0.02em" }}>
              {name}
            </div>
            {displayName && displayName.toLowerCase() !== "collector" && (
              <span style={{ fontSize: "20px", color: "rgba(203,208,213,0.6)", fontWeight: 500, letterSpacing: "0.05em" }}>
                @{username}
              </span>
            )}
            {bio && (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            {galleryCount > 0 && (
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                <div style={{ width: "6px", height: "6px", borderRadius: "50%", background: "#C8CDD2", display: "flex" }} />
                <span style={{ fontSize: "20px", color: "rgba(203,208,213,0.85)", fontWeight: 600 }}>
                  {galleryCount} public exhibition{galleryCount !== 1 ? "s" : ""}
                </span>
              </div>
            )}
            <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
              <div style={{ background: "#C8CDD2", borderRadius: "100px", padding: "12px 28px", fontSize: "16px", fontWeight: 700, color: "#0A0A12" }}>
                View Collection
              </div>
        ...
        <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", position: "relative", overflow: "hidden" }}>
          {/* Subtle radial glow */}
          <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse at center, rgba(203,208,213,0.07) 0%, transparent 65%)", display: "flex" }} />

          {/* Avatar if available */}
          {avatarUrl ? (
            <img src={avatarUrl} alt="" style={{ width: "220px", height: "220px", borderRadius: "50%", objectFit: "cover", border: "3px solid rgba(203,208,213,0.4)" }} />
          ) : (
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "center", position: "relative", width: "280px", height: "280px" }}>
              <div style={{ position: "absolute", width: "280px", height: "280px", borderRadius: "50%", border: "1px solid rgba(203,208,213,0.08)", display: "flex" }} />
              <div style={{ position: "absolute", width: "210px", height: "210px", borderRadius: "50%", border: "1px solid rgba(203,208,213,0.14)", display: "flex" }} />
              <div style={{ position: "absolute", width: "140px", height: "140px", borderRadius: "50%", border: "1px solid rgba(203,208,213,0.24)", display: "flex" }} />
              <div style={{ position: "absolute", width: "80px", height: "80px", borderRadius: "50%", border: "1px solid rgba(203,208,213,0.4)", display: "flex" }} />
              <div style={{ width: "36px", height: "36px", borderRadius: "50%", background: "rgba(203,208,213,0.15)", border: "1px solid rgba(203,208,213,0.7)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <div style={{ width: "10px", height: "10px", borderRadius: "50%", background: "#C8CDD2", display: "flex" }} />
              </div>
            </div>
          )}
        </div>
