...
import { EDITABLE_ROOM_IDS, type CampusRoomId } from "@/lib/campusLayout";
import MuseumRoomPopup from "./MuseumRoomPopup";
...
export default function RoomEditorModal({
  ...
  // Shared Museum Room Editor consolidation pass (2026-09-12): "Add Items /
  // Edit Room" now opens an in-page popup showing this one room, running the
  // exact same Organize overlay VirtualGalleryRoom.tsx uses (see
  // MuseumRoomPopup.tsx), instead of navigating to a separate
  // `/museum/vltd?edit=<roomId>` tab.
