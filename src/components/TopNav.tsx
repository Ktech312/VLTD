...
function TopNavInner() {
  ...
  return (
    <>
      ...
      >
        {/* ── Main nav row ── */}
        <div className="mx-auto flex h-[44px] md:h-[52px] max-w-[1400px] items-center gap-3 px-3 sm:px-5">

          {/* Logo */}
          <Link href="/" className="shrink-0 flex items-center">
            <Image src="/brand/vltd-logo.png" alt="VLTD" width={120} height={42} className="h-[20px] md:h-[28px] w-auto" priority />
          </Link>
