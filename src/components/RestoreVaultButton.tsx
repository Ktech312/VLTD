...
export default function RestoreVaultButton() {
  ...
  return (
    <button
      ...
      className="vltd-selectable inline-flex min-h-[42px] items-center justify-center rounded-[8px] bg-[color:var(--pill)] px-5 py-2 text-sm font-medium text-[color:var(--fg)] ring-1 ring-[color:var(--border)] transition"
    >
      Restore Vault
    </button>
  );
