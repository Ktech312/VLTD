  ...
  return (
    <div className="relative">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="inline-flex items-center justify-center rounded-[6px] px-4 py-2.5 text-sm font-bold ring-1 ring-[color:var(--border)] transition hover:brightness-110"
